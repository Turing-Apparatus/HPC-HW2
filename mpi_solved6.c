...
*
* FIX:  Waitall should not be called by process 2, since it does not perdorm
*       any nonblocking operations. Also, the initial offset for rank1 should be 0.
*       I think waitall should be changed to indivial waits in each loop iteration
*       because the buffers are being reused. In this particular prgram it doesn't
*       matter so I left it as is.
*
* Andrew Szymczak
* ajs855
******************************************************************************/
